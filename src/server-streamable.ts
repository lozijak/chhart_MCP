...
/**
 * Chhart MCP Server - StreamableHTTP Mode
 * HTTP server for remote MCP access using modern StreamableHTTP transport
 */
...
if (import.meta.url === `file://${process.argv[1]}`) {
    (async () => {
        ...
        createStreamableServer(createChhartMcpServer, port);
    })();
}
